...
void initSim() {
	...
	sim->SetPinValue(0, 22, 12.0);
	sim->SetPinValue(0, 23, 6.0);
	sim->SetPinValue(0, 24, 30.0);
	sim->SetPinValue(0, 25, 10.0);
	sim->SetPinValue(0, 26, 50.0);
	sim->SetPinValue(0, 27, 30.0);
	sim->SetPinValue(0, 28, 32.0);
